...
public final class GoBackend implements Backend {
    ...
    private static final String LEGACY_AWG_TUNNEL_NAME = "gwvpn_awg";
    private static final String AWG_SESSION_DISPLAY_NAME = "GW Amnezia 2.0";
    ...
    private void setStateInternal(final Tunnel tunnel, @Nullable final Config config, final State state)
        ...
        if (state == State.UP) {
            ...
            final String tunnelName = tunnel.getName();
            final String sessionName = LEGACY_AWG_TUNNEL_NAME.equals(tunnelName)
                    ? AWG_SESSION_DISPLAY_NAME
                    : tunnelName;
            ...
            try (final ParcelFileDescriptor tun = builder.establish()) {
                ...
                currentTunnelHandle = awgTurnOn(tunnelName, tun.detachFd(), goConfig);
            }
