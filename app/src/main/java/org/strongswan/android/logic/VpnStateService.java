...
public class VpnStateService extends Service {
    ...
    public VpnServiceLimitListener vpnServiceLimitListener;
    ...
    public void onCreate() {
        ...
        vpnServiceLimitListener = new VpnServiceLimitListener(this);
        registerListener(vpnServiceLimitListener);
    }
     ...
     *
     * @param profile current pr ofile
     */
