...
object SharePrefs {
    ...
    const val KEY_SERVER_AWG = "ServerAWG"
    const val KEY_SELECTED_PROTOCOL = "SelectedProtocol"
    const val KEY_PREMIUM = "KEY_PREMIUM"
    const val KEY_SHOULD_SHOW_BANNER = "KEY_SHOULD_SHOW_BANNER"
    const val KEY_WAS_PREMIUM = "was_premium"
    const val KEY_LAST_REMINDER_DAYS = "last_reminder_days"
}
