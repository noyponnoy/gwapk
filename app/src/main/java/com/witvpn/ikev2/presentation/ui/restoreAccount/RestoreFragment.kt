...
import com.witvpn.ikev2.databinding.FragmentRestoreBinding
...
@AndroidEntryPoint
class RestoreFragment : BaseFragment<FragmentRestoreBinding>(R.layout.fragment_restore),
    MnemonicView {
    companion object {
    ...
    override fun initBinding(view: View): FragmentRestoreBinding {
        return FragmentRestoreBinding.bind(view)
    }
...
//            }
//        }
        binding.inputMnemonic.addTextChangedListener {
            viewModel.onMnemonicInput(it.toString())
        }
//        binding.copyIcon.apply {
//            isVisible = false
...
//        binding.restoreButton.isEnabled = isEnabled
    ...
    override fun reloadUser() {
        ...
        shareViewModel.setUser(viewModel.user)
        try { findNavController().navigate(R.id.mainFragment) } catch (_: Exception) {}
    }
}
