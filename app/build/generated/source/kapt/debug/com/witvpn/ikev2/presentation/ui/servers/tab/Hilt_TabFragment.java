...
public abstract class Hilt_TabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_TabFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TabFragment_GeneratedInjector) this.generatedComponent()).injectTabFragment(UnsafeCasts.<TabFragment>unsafeCast(this));
    }
  }
