...
public abstract class Hilt_SupportFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_SupportFragment(int layoutRes) {
    super(layoutRes);
  }
