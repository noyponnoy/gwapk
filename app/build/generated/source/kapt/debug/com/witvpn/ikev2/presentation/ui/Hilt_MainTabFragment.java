...
public abstract class Hilt_MainTabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_MainTabFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MainTabFragment_GeneratedInjector) this.generatedComponent()).injectMainTabFragment(UnsafeCasts.<MainTabFragment>unsafeCast(this));
    }
  }
