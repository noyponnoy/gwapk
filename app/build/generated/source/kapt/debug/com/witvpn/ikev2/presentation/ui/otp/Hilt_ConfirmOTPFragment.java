...
public abstract class Hilt_ConfirmOTPFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_ConfirmOTPFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConfirmOTPFragment_GeneratedInjector) this.generatedComponent()).injectConfirmOTPFragment(UnsafeCasts.<ConfirmOTPFragment>unsafeCast(this));
    }
  }
