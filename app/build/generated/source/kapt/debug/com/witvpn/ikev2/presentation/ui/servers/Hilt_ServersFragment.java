...
public abstract class Hilt_ServersFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_ServersFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ServersFragment_GeneratedInjector) this.generatedComponent()).injectServersFragment(UnsafeCasts.<ServersFragment>unsafeCast(this));
    }
  }
