...
public abstract class Hilt_MnemonicFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_MnemonicFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MnemonicFragment_GeneratedInjector) this.generatedComponent()).injectMnemonicFragment(UnsafeCasts.<MnemonicFragment>unsafeCast(this));
    }
  }
