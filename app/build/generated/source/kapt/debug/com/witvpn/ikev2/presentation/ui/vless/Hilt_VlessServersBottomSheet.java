...
public abstract class Hilt_VlessServersBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VlessServersBottomSheet() {
    super();
  }

  Hilt_VlessServersBottomSheet(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VlessServersBottomSheet_GeneratedInjector) this.generatedComponent()).injectVlessServersBottomSheet(UnsafeCasts.<VlessServersBottomSheet>unsafeCast(this));
    }
  }
