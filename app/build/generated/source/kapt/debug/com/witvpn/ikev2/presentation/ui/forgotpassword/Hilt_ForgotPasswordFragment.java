...
public abstract class Hilt_ForgotPasswordFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_ForgotPasswordFragment(int layoutRes) {
    super(layoutRes);
  }
