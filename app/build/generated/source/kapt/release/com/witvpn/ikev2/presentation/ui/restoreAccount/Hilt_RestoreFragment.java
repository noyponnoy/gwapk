...
public abstract class Hilt_RestoreFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_RestoreFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RestoreFragment_GeneratedInjector) this.generatedComponent()).injectRestoreFragment(UnsafeCasts.<RestoreFragment>unsafeCast(this));
    }
  }
