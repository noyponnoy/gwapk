...
public abstract class Hilt_NewPasswordFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewPasswordFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewPasswordFragment_GeneratedInjector) this.generatedComponent()).injectNewPasswordFragment(UnsafeCasts.<NewPasswordFragment>unsafeCast(this));
    }
  }
