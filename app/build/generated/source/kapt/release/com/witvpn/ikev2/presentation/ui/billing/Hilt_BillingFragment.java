...
public abstract class Hilt_BillingFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_BillingFragment(int layoutRes) {
    super(layoutRes);
  }
