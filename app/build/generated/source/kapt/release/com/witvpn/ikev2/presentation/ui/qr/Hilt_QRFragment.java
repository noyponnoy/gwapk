...
public abstract class Hilt_QRFragment<VB extends ViewBinding> extends BindingFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QRFragment_GeneratedInjector) this.generatedComponent()).injectQRFragment(UnsafeCasts.<QRFragment>unsafeCast(this));
    }
  }
