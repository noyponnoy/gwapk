...
public abstract class Hilt_SplitTunnelFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_SplitTunnelFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SplitTunnelFragment_GeneratedInjector) this.generatedComponent()).injectSplitTunnelFragment(UnsafeCasts.<SplitTunnelFragment>unsafeCast(this));
    }
  }
