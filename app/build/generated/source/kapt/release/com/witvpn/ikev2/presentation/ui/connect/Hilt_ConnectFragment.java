...
public abstract class Hilt_ConnectFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_ConnectFragment(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConnectFragment_GeneratedInjector) this.generatedComponent()).injectConnectFragment(UnsafeCasts.<ConnectFragment>unsafeCast(this));
    }
  }
