...
public abstract class Hilt_OTPFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_OTPFragment(int layoutRes) {
    super(layoutRes);
  }
